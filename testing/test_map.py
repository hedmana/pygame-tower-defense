...
class TestMap:
    def __init__(self):
        self.grid = []
        self.nodes = []
        self.path = 'testing/test_map.csv'
            ...
            for row in data:
                ...
                for i in row:
                    if i == '1':
                        ...
                        temp_row.append(GameTile(self.road_img, x, y, 2))
                    elif i == 'E':
                        temp_row.append(GameTile(self.road_img, x, y, 3))
                    else:
                        pass
                        #raise ValueError('Unknown character in map.csv')
                    x = x + 100
                y = y + 100
                x = 0
    ...
    def read_default_map(self):
        ...
        self.read_map_from_csv()
        print("Unreadable map! Map set to default.")
